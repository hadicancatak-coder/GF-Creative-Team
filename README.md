...
`MISSED — client caught after ~500k tokens`. Twelve of the thirty-four are marked MISSED — meaning a
...
- **Evals with outcomes recorded.** 34 cases, each naming the agent that must catch it *unhinted*, each
