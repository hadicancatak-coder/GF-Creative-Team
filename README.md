...
`MISSED — client caught after ~500k tokens`. Twelve of the thirty-seven are marked MISSED — meaning a
...
- **Evals with outcomes recorded.** 37 cases, each naming the agent that must catch it *unhinted*, each
