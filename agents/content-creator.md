...
## Craft
- Follow the client's headline grammar exactly (e.g. subject line + accent promise line).
- Sublines carry verifiable facts only, in the client's approved numbers.
- CTA is the ONLY action phrasing, 1–3 words. Eyebrows are labels, never actions.
